...
export default function CancelPage() {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-b from-red-50 to-red-100 flex items-center justify-center p-4"
    >
      <Card className="w-full max-w-md shadow-xl rounded-2xl overflow-hidden border-0">
        <CardHeader className="bg-red-50/50 p-8">
          <motion.div
            initial={{ scale: 0.8 }}
            animate={{ scale: 1 }}
          ...
          <CardTitle className="text-3xl font-extrabold text-center text-red-900">
            Rendelés törölve
          </CardTitle>
        </CardHeader>
        ...
        <CardContent className="p-8">
          ...
          <div className="text-center text-sm text-red-700 space-y-1">
